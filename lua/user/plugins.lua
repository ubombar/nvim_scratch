...
require("lazy").setup({
		...
		config = function()
			require("bufferline").setup({
				options = {
					...
					separator_style = "slant", -- how separators between tabs look: "slant", "padded_slant", "thick", "thin", or { 'left', 'right' }
	...
	-- Gitsigns: This is used to add git signs git blame etc.
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>ht", gs.toggle_current_line_blame, { desc = "Toggle inline blame" })
		end,
	},
